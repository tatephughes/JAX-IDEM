...
# plot the objects
gif_st_grid(process_data, "process.gif", width=width, height=height)
gif_st_pts(obs_data, "obs.gif", width=width, height=height)
model.kernel.save_fig("kernel.png", width=width, height=height)
