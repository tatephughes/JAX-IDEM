...
* TODO Make filt_results a proper class with methods to get any filtered quantity (in a lazy way) regardless of the type of filter used. If this is possible in python.
