...
model = gen_example_idem(keys[0], k_spat_inv=False, ngrid=jnp.array([40, 40]), process_basis = process_basis, sigma2_eta=1)

# Simulation
T = 35
alpha_0 = jnp.ones(process_basis.nbasis).at[1].set(30.0).at[0].set(15.0)
process_data, obs_data = model.simulate(key, T=T, nobs=50,alpha_0=alpha_0)
