...
\NormalTok{df }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}data/varying\_n\_32.csv\textquotesingle{}}\NormalTok{)}
...
\NormalTok{fig.write\_image(}\StringTok{"figure/scale\_test\_n\_32.png"}\NormalTok{)}
\NormalTok{fig.show()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    labels}\OperatorTok{=}\NormalTok{\{}\StringTok{"n"}\NormalTok{: }\StringTok{"number of observations"}\NormalTok{, }\StringTok{"value"}\NormalTok{: }\StringTok{"Time (seconds)"}\NormalTok{\},}
\NormalTok{    title}\OperatorTok{=}\StringTok{"Compuile Time of Filters Varying r (32 bit)"}
\NormalTok{)}
