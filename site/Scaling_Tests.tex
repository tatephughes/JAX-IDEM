...
\chapter{Laptop RTX 4060 (Lovelace)}\label{laptop-rtx-4060-lovelace}
...
\NormalTok{rename\_map }\OperatorTok{=}\NormalTok{ \{}
    \StringTok{"kalman\_run"}\NormalTok{: }\StringTok{"Kalman"}\NormalTok{,}
    \StringTok{"sqrt\_run"}\NormalTok{: }\StringTok{"Square{-}root"}\NormalTok{,}
    \StringTok{"inf\_run"}\NormalTok{: }\StringTok{"Information"}\NormalTok{,}
    \StringTok{"sqinf\_run"}\NormalTok{: }\StringTok{"Sqrt Information"}\NormalTok{,}
\NormalTok{\}}

\CommentTok{\# Apply renaming}
\NormalTok{df\_combined[}\StringTok{"Filter"}\NormalTok{] }\OperatorTok{=}\NormalTok{ df\_combined[}\StringTok{"Filter"}\NormalTok{].replace(rename\_map)}
...
\NormalTok{fig.write\_image(}\StringTok{"figure/scale\_test\_n\_laptop.png"}\NormalTok{)}
\NormalTok{fig.show()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
/tmp/ipykernel_22143/2547227509.py:51: DeprecationWarning:
...
\chapter{NCC (Ampere)}\label{ncc-ampere}
...
\CommentTok{\# Load the datasets}
\NormalTok{df64 }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}data/varying\_n\_ncc\_64.csv\textquotesingle{}}\NormalTok{)}
\NormalTok{df32 }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}data/varying\_n\_ncc\_32.csv\textquotesingle{}}\NormalTok{)}
...
\NormalTok{fig.write\_image(}\StringTok{"figure/scale\_test\_n\_ampere.png"}\NormalTok{)}
\NormalTok{fig.show()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
/tmp/ipykernel_22143/3675275947.py:51: DeprecationWarning:
...
\chapter{NCC (Turing)}\label{ncc-turing}
...
\CommentTok{\# Load the datasets}
\NormalTok{df64 }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}data/varying\_n\_turing\_64.csv\textquotesingle{}}\NormalTok{)}
\NormalTok{df32 }\OperatorTok{=}\NormalTok{ pd.read\_csv(}\StringTok{\textquotesingle{}data/varying\_n\_turing\_32.csv\textquotesingle{}}\NormalTok{)}
...
\NormalTok{fig.write\_image(}\StringTok{"figure/scale\_test\_n\_turing.png"}\NormalTok{)}
\NormalTok{fig.show()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
/tmp/ipykernel_22143/3756852843.py:51: DeprecationWarning:
