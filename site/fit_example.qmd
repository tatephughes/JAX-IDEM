...
alpha_0 = jnp.zeros(nbasis).at[20].set(10)

process_data, obs_data = truemodel.simulate(nobs=50, T=3, key=keys[1], alpha_0 = alpha_0)
...
import optax 
model1 = model0.fit_information_filter(obs_data=obs_data,
                                       X_obs_tuple=X_obs_tuple, 
                                       nits=100,
                                       optimizer=optax.adam(1e-1),
#                                  fixed_ind = ['sigma2_eps', 'sigma2_eta']
                                                                        )
...
ll, nus, Qs, _, _ = truemodel.filter_information(obs_data)
