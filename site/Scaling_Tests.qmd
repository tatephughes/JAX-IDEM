...
df = pd.read_csv('data/scale_tests_ncc_32.csv')
...
df = pd.read_csv('data/scale_tests_ncc_64.csv')
...
# Show the plot
fig.write_image("figure/scale_test.png")
fig.show()
```
...
fig = px.line(
    ...
    y=df.columns[7:], 
    labels={"n": "number of observations", "value": "Time (seconds)"},
    title="Compuile Time of Filters Varying n (64 bit)"
)

# Show the plot
fig.write_image("figure/scale_test_compile.png")
fig.show()
```
...
df = pd.read_csv('data/scale_tests_ncc_r_32.csv')
...
fig = px.line(
    ...
    y=df.columns[3:7], 
    labels={"n": "number of observations", "value": "Time (seconds)"},
    title="Filters Comparison with Varying r (nbasis is r^2)"
)

# Show the plot
fig.write_image("figure/scale_test_r.png")
fig.show()
```
