...
csv_data = np.loadtxt('results/Hamilton/bigruns/2025-05-07_21:30:26_results_rmh.csv', delimiter=',')
...
# Load the CSV file using NumPy
csv_data = np.loadtxt('results/Hamilton/bigruns/2025-05-07_21:44:50_results_hmc.csv', delimiter=',')
# Convert the NumPy array to a JAX array
rmh_sample = jnp.array(csv_data)[:,1:]
