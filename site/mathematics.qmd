...
$$\begin{split}
  P_{t+1\mid t+1}= (I - K_{t+1} \Phi_{t+1}) P_{t+1\mid t}(I - K_{t+1} \Phi_{t+1})^\intercal + \Sigma_{\epsilon},
\end{split}
$$
...
$$\begin{split}
  ...
  &= (I - K_{t+1} \Phi_{t+1})(\bv \alpha_t - \bv m_{t+1 \mid t}) - \bv \epsilon_{t+1}.
\end{split}
$$
...
Which, noting that $\bv \epsilon_{t+1}$ are independant of $\bv \alpha_t$ and $\mathbb E[(\bv \alpha_t - \bv m_{t+1 \mid t})^\intercal (\bv \alpha_t - \bv m_{t+1 \mid t})]=P_{t+1\mid t}$, gets us the result.
