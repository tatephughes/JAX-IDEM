...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{process\_data.save\_plot(}\StringTok{\textquotesingle{}figure/process\_data\_example.png\textquotesingle{}}\NormalTok{)}
\NormalTok{obs\_data.save\_plot(}\StringTok{\textquotesingle{}figure/obs\_data\_example.png\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
