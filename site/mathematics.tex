...
\NormalTok{obs\_fig.write\_image(}\StringTok{"figure/process\_data\_example.png"}\NormalTok{, }\BuiltInTok{format}\OperatorTok{=}\StringTok{"png"}\NormalTok{, scale}\OperatorTok{=}\DecValTok{2}\NormalTok{)}
\NormalTok{proc\_fig.write\_image(}\StringTok{"figure/obs\_data\_example.png"}\NormalTok{, }\BuiltInTok{format}\OperatorTok{=}\StringTok{"png"}\NormalTok{, scale}\OperatorTok{=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{figure/process_data_example.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figure/obs_data_example.png}}
