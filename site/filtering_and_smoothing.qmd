...
ll, ms, Ps, _, _, _ = filt.kalman_filter(m_0,
                                         P_0,
                                         M,
                                         PHI,
                                         sigma2_eta,
...
ll2, nus, Qs,_ ,_  = filt.information_filter(nu_0,
                                            Q_0,
                                            M,
                                            PHI_tuple,
                                            sigma2_eta,
...
ll3, ms3, Us, _, _, _ = filt.sqrt_filter(m_0,
                                         U_0,
                                         M,
                                         PHI,
                                         sigma2_eta,
...
ll4, nus2, Rs2,_ ,_  = filt.sqrt_information_filter(nu_0,
                                                    R_0,
                                                    M,
                                                    PHI_tuple,
                                                    sigma2_eta,
...
Qs2 = jnp.matmul(jnp.transpose(Rs2, (0, 2, 1)), Rs2)

ms4 = jnp.linalg.solve(Qs2, nus2[..., None]).squeeze(-1)
